    ...
    <>
      ...
      <section className="bg-zinc-900/40 border-y border-zinc-800/50 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-white">Prefer the terminal?</h2>
            <p className="mt-3 text-zinc-400 max-w-lg mx-auto">
              Install Hermes Agent directly with a single command — no desktop app needed.
      ...
      <section className="relative overflow-hidden border-t border-zinc-800/50 py-24 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-2xl px-6">
          <h2 className="mb-4 text-4xl font-bold text-white">Get Hermes Desktop</h2>
